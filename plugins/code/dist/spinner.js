 ...
 */
export async function playCooldown(message = "saving memory") {
 ...
 */
export function renderWave(length = 8) {
    let wave = "";
 ...
 */
export async function withSpinner(operation, message = "Loading...", successMessage) {
