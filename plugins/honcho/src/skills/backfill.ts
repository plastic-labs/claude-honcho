/**
 * Backfill — imports local Claude Code session transcripts into Honcho.
 *
...
import { findTranscripts, parseTranscriptForBackfill, type ParsedMessage } from "./transcript-parse.js";
