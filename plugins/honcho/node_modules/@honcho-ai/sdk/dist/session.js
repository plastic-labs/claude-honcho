...
class Session {
     ...
     */
    constructor(id, workspaceId, http, metadata, configuration, ensureWorkspace = async () => undefined) {
        this.id = id;
    ...
    async peers() {
        ...
        return peersPage.items.map((peer) => new peer_1.Peer(peer.id, this.workspaceId, this._http, undefined, undefined, () => this._ensureWorkspace()));
    }
    /**
    ...
    async clone(messageId) {
        ...
        return new Session(clonedSessionData.id, this.workspaceId, this._http, clonedSessionData.metadata ?? undefined, (0, validation_1.sessionConfigFromApi)(clonedSessionData.configuration) ?? undefined, () => this._ensureWorkspace());
    }
    /**
    ...
    async context(options) {
        ...
        const searchQueryText = typeof opts.searchQuery === 'string'
            ? opts.searchQuery
        ...
        const searchQueryParsed = typeof contextParams.searchQuery === 'string'
    ...
    async uploadFile(file, peer, options) {
        ...
        if (uploadParams.configuration !== undefined &&
            ...
            formData.append('configuration', JSON.stringify(uploadParams.configuration));
        }
