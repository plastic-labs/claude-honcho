...
class Peer {
    ...
    async sessions(filters) {
        ...
        return new pagination_1.Page(sessionsPage, (session) => new session_1.Session(session.id, this.workspaceId, this._http, session.metadata ?? undefined, session.configuration ?? undefined), fetchNextPage);
    }
    /**
